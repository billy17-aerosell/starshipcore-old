...
local Translations = {
	...
	en = {
		...
		auto_checkpoint_desc = "Auto-save recording when stage/checkpoint changes",
		auto_checkpoint_enabled = "Auto-Checkpoint Enabled",
		auto_checkpoint_disabled = "Auto-Checkpoint Disabled",
		checkpoint_saved = "⚡ Checkpoint Saved",
		checkpoint_stage = "Stage %s",
		checkpoint_saved_as = "Saved as: %s",
		checkpoint_no_leaderstat = "No leaderstats detected",
		checkpoint_detected = "Detected: %s",
		checkpoint_saves = "Saves: %d",
		checkpoint_base_name = "Base Name...",
		checkpoint_monitoring = "Monitoring: %s",
		checkpoint_recording_stopped = "%s | Recording Stopped",
		auto_stop = "AUTO STOP",
		auto_stop_desc = "Stop recording after checkpoint",
		checkpoint_reset = "Stage Reset",
		stage_decreased = "Stage %d → %d (reset to start)",
		loop_detected = "Loop Detected",
		waiting_for_teleport = "Recording until teleport to start...",
	},
	...
	id = {
		...
		-- Auto-Checkpoint System
		auto_checkpoint = "AUTO-CHECKPOINT",
		auto_checkpoint_desc = "Simpan otomatis rekaman saat stage/checkpoint berubah",
		auto_checkpoint_enabled = "Auto-Checkpoint Diaktifkan",
		auto_checkpoint_disabled = "Auto-Checkpoint Dinonaktifkan",
		checkpoint_saved = "⚡ Checkpoint Tersimpan",
		checkpoint_stage = "Stage %s",
		checkpoint_saved_as = "Disimpan sebagai: %s",
		checkpoint_no_leaderstat = "Tidak ada leaderstats terdeteksi",
		checkpoint_detected = "Terdeteksi: %s",
		checkpoint_saves = "Tersimpan: %d",
		checkpoint_base_name = "Nama Dasar...",
		checkpoint_monitoring = "Memantau: %s",
		checkpoint_recording_stopped = "%s | Rekaman Berhenti",
		auto_stop = "AUTO STOP",
		auto_stop_desc = "Hentikan rekaman setelah checkpoint",
		checkpoint_reset = "Stage Direset",
		stage_decreased = "Stage %d → %d (kembali ke awal)",
		loop_detected = "Loop Terdeteksi",
		waiting_for_teleport = "Merekam sampai teleport ke awal...",
	},
}
