local function SetupFunUI(PageFun, UI, Connections, Config, LocalPlayer, UIHandlers, RegisterTheme)
    ...
    -- Using AlignPosition constraint for server-visible physics (like Part Manipulation)
        ...
        local function CollectPart(part)
            ...
            local success = pcall(function()
                ...
                for _, c in pairs(part:GetChildren()) do
                    if c:IsA("BodyMover") or c.Name == "AuraAlign" or c.Name == "AuraAtt" or c.Name == "FlingVelocity" then
                        c:Destroy()
                    end
                end
