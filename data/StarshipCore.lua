...
local function SetupKeySystem()
	...
	task.spawn(function()
		...
		while Title and Title.Parent do
			...
			Title.Text = string.format(
				'<font color="rgb(%d,%d,%d)">STARSHIP</font> <font color="rgb(255,255,255)" size="14">v0.9-BETA</font>',
				r,
				g,
				b
			)
	...
	TweenService:Create(
		...
		{ Size = UDim2.new(0, keyFrameWidth, 0, 200), BackgroundTransparency = 0 }
	):Play()
	task.wait(0.3)
