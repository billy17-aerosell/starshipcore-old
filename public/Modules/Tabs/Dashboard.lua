...
local DISCORD_LINK = "https://discord.gg/starship"

return function(Page, UI, Connections, Config, LocalPlayer, UIHandlers, RegisterTheme)
    Page:ClearAllChildren()
    
    local MainContainer = Instance.new("Frame", Page)
    ...
    CreateInfoRow(PlayerCard, "Username", LocalPlayer.Name, 28)
    CreateInfoRow(PlayerCard, "Display Name", LocalPlayer.DisplayName, 50)
