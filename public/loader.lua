...
local function main()
	...
	local b1, b2, b3 = string.byte(decryptedCode, 1, 3)
	if b1 == 239 and b2 == 187 and b3 == 191 then
		decryptedCode = string.sub(decryptedCode, 4)
	end

	-- DEBUG: Print first 50 chars to verify decryption
	print("[Starship] Decrypted Code Start:", string.sub(decryptedCode, 1, 50))
