...
Access the web-based management dashboard (URL kept private for security).

> ⚠️ **Security Note:** Dashboard URL is not publicly documented to prevent unauthorized access.
...
│   ├── panel-[hash].html         # Admin dashboard (hidden)
│   └── ...                       # Other public assets
│
